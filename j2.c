...
void NomJoueur(char player[2][30]){
    ...
    printf("Veuillez attendre que joueur 1 ait validé son nom. Renseignez ensuite le votre :\n");
...
void connect_to_server(void)
{
    ...
    {
        printf("Impossible de se connecter. Veuillez réessayer.\n");
        exit(0);
    }
    ...
    // Demander de connexion à l'hôte
    if(connect(s, (struct sockaddr *)&server_addr, sizeof(server_addr)) < 0)
    {
        printf("La connexion n'a pas été établie. Merci de consulter l'aide et de réessayer.\n");
        exit(0);
    };
    return;
}
